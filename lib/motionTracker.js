var method = MotionTrackerServer.prototype;


function MotionTrackerServer(blobReaderPortNumber, csvCameraSettingsFile) {

    var io = require('socket.io')(blobReaderPortNumber);
    var net = require("net");
    ...
    var manager = new bm(processCallback, csvCameraSettingsFile);
...
method.listenForBlobs = function(portNumber) {
